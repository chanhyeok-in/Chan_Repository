package com.tsconpany.axboot.domain.init;

import com.tsconpany.axboot.domain.code.CommonCode;
import com.tsconpany.axboot.domain.code.CommonCodeService;
import com.tsconpany.axboot.domain.program.Program;
import com.tsconpany.axboot.domain.program.ProgramService;
import com.tsconpany.axboot.domain.program.menu.Menu;
import com.tsconpany.axboot.domain.program.menu.MenuService;
import com.tsconpany.axboot.domain.user.User;
import com.tsconpany.axboot.domain.user.UserService;
import com.tsconpany.axboot.domain.user.auth.UserAuth;
import com.tsconpany.axboot.domain.user.auth.UserAuthService;
import com.tsconpany.axboot.domain.user.auth.menu.AuthGroupMenu;
import com.tsconpany.axboot.domain.user.auth.menu.AuthGroupMenuService;
import com.tsconpany.axboot.domain.user.role.UserRole;
import com.tsconpany.axboot.domain.user.role.UserRoleService;
